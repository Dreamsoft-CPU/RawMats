...
CREATE TABLE "User" (
    ...
    "profilePicture" TEXT NOT NULL DEFAULT '/users/default.jpg',
    "phoneNumber" TEXT NOT NULL DEFAULT 'None',
...
CREATE TABLE "Supplier" (
    ...
    "businessPicture" TEXT NOT NULL DEFAULT '/businesses/default.jpg',
    "businessName" TEXT NOT NULL,
    "businessLocation" TEXT NOT NULL,
    "businessPhone" TEXT NOT NULL DEFAULT 'None',
...
CREATE TABLE "Product" (
    ...
    "image" TEXT NOT NULL DEFAULT '/products/default.jpg',
...
-- AddForeignKey
ALTER TABLE "AlbumFavorite" ADD CONSTRAINT "AlbumFavorite_favoriteId_fkey" FOREIGN KEY ("favoriteId") REFERENCES "Favorite"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AlbumFavorite" ADD CONSTRAINT "AlbumFavorite_albumId_fkey" FOREIGN KEY ("albumId") REFERENCES "Album"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
